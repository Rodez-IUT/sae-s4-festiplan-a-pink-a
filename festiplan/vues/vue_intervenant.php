...
<body class="body-blanc">
        ...
        <div class="table-scrollable">
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <td><a href="?controller=Spectacle&action=modifierIntervenant&idIntervenant=<?php echo $row['idIntervenant'];?>&idSpectacle=<?php echo $row['idSpectacle'];?>"><span class="fas fa-solid fa-pen-to-square iconeGrandi iconeNoir"></span></a></td>
    ...
    <div class="container-fluid footer">
        <div class="row">
            ...
            <div class="col-4">
                <a href="?controller=Spectacle&action=ajouterIntervenant&idSpectacle=<?php echo $idSpectacle;?>"><button type="button" class="btn btn-success btnModif fondVert"><span class="fas fa-solid fa-plus"></span><b> Intervenant</b></button></a>
            </div>
            <div class="col-4">
